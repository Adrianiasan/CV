...
const t = {
  ...
  hero: {
    ...
    bio: {
      ro: "Dezvoltator Full-Stack din Moldova (Comrat) cu 3+ ani de experiență în construirea aplicațiilor web moderne. Specializat în Next.js și ecosistemul JavaScript — creez site-uri curate, rapide și ușor de folosit, menite să crească vânzările și numărul de clienți, de la idee până la lansare. În colaborarea cu clienții pun accent pe comunicare directă și atenție la detalii: îmi place să înțeleg cu adevărat cerința înainte de a propune o soluție, astfel încât rezultatul să rezolve problema reală, nu doar să arate bine. În afara muncii, îmi place să explorez tehnologii noi și tendințe din web design, sunt pasionat de fotografie și de istoria locală — lucruri care mă ajută să privesc fiecare proiect dintr-o perspectivă proaspătă.",
      ru: "Full-Stack разработчик из Молдовы (г. Комрат) с 3+ годами опыта создания современных веб-приложений. Специализируюсь на Next.js и JavaScript-экосистеме — создаю чистые, быстрые и удобные сайты с целью повысить продажи и число клиентов, от идеи до запуска. В работе с клиентами ценю прямую коммуникацию и внимание к деталям: стараюсь по-настоящему вникнуть в задачу, прежде чем предлагать решение, чтобы результат действительно решал проблему, а не просто хорошо выглядел. Вне работы люблю разбираться в новых технологиях и трендах веб-дизайна, увлекаюсь фотографией и историей родного края — это помогает смотреть на каждый проект свежим взглядом.",
      en: "Full-Stack developer from Moldova (Comrat) with 3+ years of experience building modern web applications. Specialized in Next.js and the JavaScript ecosystem — I create clean, fast, and user-friendly websites designed to increase sales and grow the client base, from idea to launch. When working with clients, I value direct communication and attention to detail: I like to truly understand the requirement before proposing a solution, so the result actually solves the problem rather than just looking good. Outside of work, I enjoy exploring new technologies and web design trends, and I'm into photography and local history — things that help me look at every project with a fresh perspective.",
    },
