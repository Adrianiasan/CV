      ...
      <div className="dash-cols" style={{ display: "flex", padding: "36px 32px 80px", gap: 32, alignItems: "flex-start" }}>
        ...
        <aside className="dash-aside" style={{
          ...
          <div style={{ padding: "26px 22px 28px" }}>
            ...
            {/* Photo + name/title overlay */}
            <button
              onClick={() => setPhotoOpen(true)}
              aria-label="Vezi fotografia mărită"
              style={{
                display: "block", width: "100%", position: "relative", border: "none", background: "none",
                padding: 0, cursor: "pointer", marginBottom: 16, borderRadius: 16, overflow: "hidden", aspectRatio: "9 / 16",
              }}
            >
              ...
              <div style={{ position: "absolute", left: 0, right: 0, bottom: 0, padding: "18px 14px", textAlign: "center" }}>
                <h1 style={{ fontFamily: "var(--font-playfair)", fontSize: "1.4rem", fontWeight: 700, color: "#fff", lineHeight: 1.1, marginBottom: 6 }}>
                  Adrian Iașan
                </h1>
                <p style={{ fontSize: 9.5, fontWeight: 800, letterSpacing: "0.18em", color: GOLD, textTransform: "uppercase" }}>
                  {lbl("devTitle")}
                </p>
              </div>
            </button>
